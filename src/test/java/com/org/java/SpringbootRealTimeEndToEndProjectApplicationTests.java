 ...
 * org.mockito.Mockito.doReturn; import static org.mockito.Mockito.times; import
 ...
 * org.springframework.test.context.event.annotation.AfterTestClass; import
 * org.springframework.test.context.event.annotation.BeforeTestClass;
 * 
 * import com.org.java.entity.Employee; import
 * com.org.java.repository.EmployeeRepository; import
 * com.org.java.service.EmployeeService;
 * 
 * @SpringBootTest class SpringbootRealTimeEndToEndProjectApplicationTests {
 * 
 * @Autowired private EmployeeService employeeService;
 * 
 * @MockBean private EmployeeRepository employeeRepository;
 * 
 * @BeforeTestClass public void beforeClassTest() {
 * System.out.println("it is print before class will executeded...."); }
 * 
 * @Before(value = "caluculateSubTest") public void beforeTest() {
 * System.out.println("will executed before Test"); }
 * 
 * 
 * 
 * 
 * @Test public void saveTest() { Employee emp = new Employee(211, "nave", 52,
 * 85, "75"); when(employeeRepository.save(emp)).thenReturn(emp);
 * assertEquals(emp, employeeService.saveEmployeeDetails(emp)); }
 * 
 * @AfterTestClass public void afterTest() {
 ...
 * Employee(102,"Danile", 35.0,55, "Govt"), new Employee(102,"Danile", 35.0,55,
 * "Govt"), new Employee(102,"Danile", 35.0,55,
 * "Govt")).collect(Collectors.toList()));
 * assertEquals(3,employeeService.findAllEmployeeDetails().size()); Employee emp
 * = new Employee(102, "prakash", 78.0, 45, "testdept");
 ...
 * when(employeeRepository.findAll()).thenReturn(Stream .of(new
 * Employee(100,"Danile", 35.0,55, "Govt"), new Employee(100,"Danile", 35.0,55,
 * "Govt"), new Employee(100,"Danile", 35.0,55,
 * "Govt")).collect(Collectors.toList())); assertEquals(3,
